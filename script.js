...
const wordsData = [
    ...
    { yezidi: "𐺑𐺌𐺁𐺦𐺧 𐺊𐺩𐺍", kurmanji: "Guten Morgen", arabic: "صباح الخير", audio: "audio/guten_morgen.mp3" },
    { yezidi: "𐺐𐺌 𐺝𐺦𐺍𐺦𐺡𐺀 𐺊𐺤𐺦", kurmanji: "Bitte", arabic: "من فضلك / العفو", audio: "audio/bitte.mp3" },
    { yezidi: "𐺊𐺠𐺡𐺦𐺄 𐺜𐺦𐺁𐺣𐺠", kurmanji: "Danke", arabic: "شكراً", audio: "audio/danke.mp3" },
    { yezidi: "𐺁𐺦𐺠𐺩", kurmanji: "Ja", arabic: "نعم", audio: "audio/ja.mp3" },
    { yezidi: "𐺢𐺀", kurmanji: "Nein", arabic: "لا", audio: "audio/nein.mp3" },
    { yezidi: "𐺀𐺛", kurmanji: "Wasser", arabic: "ماء (ألماني)", audio: "audio/wasser.mp3" },
    { yezidi: "𐺢𐺀𐺢", kurmanji: "Brot", arabic: "خبز", audio: "audio/brot.mp3" },
    { yezidi: "𐺡𐺀𐺠", kurmanji: "Haus", arabic: "منزل", audio: "audio/haus.mp3" },
    { yezidi: "𐺄𐺦𐺍𐺦𐺡𐺃𐺩𐺠", kurmanji: "Auto", arabic: "سيارة", audio: "audio/auto.mp3" },
    { yezidi: "𐺝𐺄𐺩𐺁", kurmanji: "Buch", arabic: "كتاب", audio: "audio/buch.mp3" },
    { yezidi: "𐺡𐺦𐺝𐺄𐺀𐺁", kurmanji: "Schule", arabic: "مدرسة", audio: "audio/schule.mp3" },
    { yezidi: "𐺧𐺦𐺛𐺀𐺠", kurmanji: "Freund", arabic: "صديق", audio: "audio/freund.mp3" },
    { yezidi: "𐺡𐺀𐺁𐺀𐺄", kurmanji: "Familie", arabic: "عائلة", audio: "audio/familie.mp3" },
    { yezidi: "𐺤𐺦𐺊𐺄", kurmanji: "Zeit", arabic: "وقت", audio: "audio/zeit.mp3" },
    { yezidi: "𐺍𐺣𐺐", kurmanji: "Tag", arabic: "يوم", audio: "audio/tag.mp3" },
